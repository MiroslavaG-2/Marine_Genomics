...
Based on the data we have it is an interspersed repeat, but not bey being in different chromosomes/cotigs. All six alignments are on the same contig (tig00000584), with each repeat copy being roughly 5000-5300 bp long, but with huge gaps between consecutive copies of around 95000-370000 bp apart.
